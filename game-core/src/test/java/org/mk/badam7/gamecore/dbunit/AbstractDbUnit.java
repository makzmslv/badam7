...
@ContextConfiguration(locations = { "classpath:databaseContextforTest.xml" })
...
public abstract class AbstractDbUnit
{
    ...
    private static final String DATA_SET_BASE_PATH = "src/test/resources/datasets/";
    private static final String databaseSchema = "../database/src/test/resources/liquibase/master.xml";
